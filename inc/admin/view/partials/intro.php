...
<div class="two-col">
	<div class="col">
		...
		<p><strong><?php printf( esc_html__( 'Development of this plugin is done on %1$sGitHub%2$s. Pull requests welcome.', 'envato-market' ), '<a href="https://github.com/envato/wp-envato-market" target="_blank">', '</a>' ); ?></strong></p>
	</div>
